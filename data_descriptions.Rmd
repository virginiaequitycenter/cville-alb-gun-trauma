...
```{r gva_participants, message=FALSE}
...
```{r odp_crime, message=FALSE, warning=FALSE}
...
The Virginia Open Data Portal includes the number and rate of emergency department (ED) visits for firearm injury (FAI) in Virginia from 2015 - 2024, aggregated by county and patient demographics. This data is supplied by the Virginia Department of Health and updated monthly. 
...
```{r vdh, message=FALSE, warning=FALSE}
