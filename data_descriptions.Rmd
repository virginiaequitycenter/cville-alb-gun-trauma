...
Crime data for Virginia are derived from National Incident-Based Reporting System (NIBRS) reports voluntarily submitted to the FBI.

The 2022 estimated Crime statistics for Virginia are based on data received from 410 of 418 participating law enforcement agencies in the state that year.
