...
The VDH data groups Charlottesville City and Albemarle county together for their firearm injury counts. 
...
fai_county %>%
  ...
  reactable(
    ...
    bordered = TRUE,
    highlight = TRUE) %>%
  add_title(title = "Rates of Firearm Injuries in Charlottesville and Albemarle", 
            font_size = 20,
            font_weight = "normal",
            margin = margin(b = 5)) %>%
  add_subtitle(subtitle = "2015-2023",
               font_size = 16,
               font_weight = "normal",
               margin = margin(b = 5)) %>%
  add_source(source = "Source: https://data.virginia.gov/dataset/vdh-pud-fai-by-citycounty",
             align = "right",
             font_size = 10,
             font_style = "italic")
...
fai_age %>%
  ...
  reactable(
    ...
    highlight = TRUE,
    defaultPageSize = 11) %>%
  add_title(title = "Firearm Deaths by Age in the Blue Ridge Health District", 
            font_size = 20,
            font_weight = "normal",
            margin = margin(b = 5)) %>%
  add_subtitle(subtitle = "2018-2022",
               font_size = 16,
               font_weight = "normal",
               margin = margin(b = 5)) %>%
  add_source(source = "Source: https://data.virginia.gov/dataset/vdh-pud-firearm-deaths-by-district-age",
             align = "right",
             font_size = 10,
             font_style = "italic")
