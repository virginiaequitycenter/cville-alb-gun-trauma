...
The [Charlottesville Open Data Portal](https://opendata.charlottesville.org/datasets/charlottesville::crime-data/about) includes over 500 crime reports in City of Charlottesville from March 2019 through April 2014. As defined by the Charlottesville Police Department, this data "represents the initial information that is provided by individuals calling for police assistance." The data is maintained by CPD and updated nightly. 

The dataset includes the time of a call, the type of incident, the location of the incident, and the reporting officer. It's important to note that just because a call was made, does not mean that an arrest was made. This is not a definitive collection of public safety data for Charlottesville. 

Because there is not a comparable portal, this dataset is limited to incidents that occur within city limits. That means it does not include Albemarle County or UVA crime information. 

We also should consider the factors that influence the inclination of an individual calling the police. Are there systematic reasons that someone might call the police more or less than someone else? 

We also need to remember the deeply human aspect of this data as well. For each report, there are at least 1, usually 2 or 3, individuals involved. There’s the caller, or the person reporting the crime, the police officer recording the crime, and there’s the individual that supposedly committed this crime. Granted personal info is scrubbed from this report, we should keep in mind that these are individuals we are talking about. 
