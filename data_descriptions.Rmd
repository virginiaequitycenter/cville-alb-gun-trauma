...
The script [data_prep.R](https://github.com/virginiaequitycenter/cville-alb-gun-trauma/blob/main/scripts/data_prep.R) outlines the process for accessing and cleaning each data source. We encourage anyone interested to recreate these analyses or extend them by contributing their own data-driven insights.
...
<br>
<br>
The line graph above shows the rate of gun violence crimes per 100k population over time. In Virginia, the crime rate has been slightly increasing from 19.2 in 2016 to 24.4 in 2023, with a peak of 25.6 in 2022. That means on average in Virginia in 2023, for every 100,000 people, there were 24 crimes involving firearms. Charlottesville rates are much more variable with rates peaking above state levels from 2020 to 2022, with a maximum value of 28 in 2021. Albemarle has had relatively steady rates ranging from a minimum of 7.4 in 2021 to a maximum of 11 in 2022.
<br>
<br>
Overall during the COVID-10 pandemic, the rate of crimes committed with firearms increased across the board, and in Charlottesville specifically. Since 2022, however, the rate has been slightly decreasing. 
</p>
...
<br>
<br>
From 2021 to 2022 the firearm crime rate increased for youth across the board. In Charlottesville this change was exponential, with the rate more than doubling from 0.8 in 2021 to 2.1 -- above the statewide average -- in 2022. The rate has decreased from 2022 to 2023, to 1.4, below the state average. That means for every 100,000 people, there were 1.4 crimes committed with guns by individuals under the age of 18. 
</p>
