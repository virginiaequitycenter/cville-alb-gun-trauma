...
Sourced from the [Gun Violence Archive](https://www.gunviolencearchive.org/), this data includes information collected from public news sources about 201 incidents of gun violence affecting 306 participants in the Charlottesville/Albemarle region from May 2014 - April 2024. The incidents range from shots fired reports, to unlawful gun ownership, to acts of violence such as assault, suicide, and homicide. The data does not include information about suicides.
...
## Federally Licensed Firearms Dealers {.tabset}

The [Bureau of Alcohol, Tobacco, Firearms, and Explosives (ATF)](https://www.atf.gov/firearms) maintains a record of all federally licensed firearms dealers. Some of these dealers are publicly accessible businesses, such as the Walmart on 29, while others are individuals that operate out of residential neighborhoods. The list and map below show the 22 authorized dealers in Charlottesville and Albemarle county as of April 2024.
...
With over 16,700 undergraduate students coming to the region each semester to study at UVA [UVA Statistics](https://admission.virginia.edu/admission/statistics), the youth population of Charlottesville and Albemarle is significantly large and transient. 

The map below shows the percentages of the population that are under 18 and 25 years old. It is important to note that the JPA - Fontaine and Carr's Hill - McCormick tracts house a large number of students, with nearly all first years living in dorms in the McCormick region. As a result, some of the data for these regions may be skewed. To account for the student population, we chose the ages of 18 and 24 as cutoff points so that we can better understand both populations of our region. 
...
gv_sf_summary <- dat %>% 
  ...
  mutate(incidents_pop = (counts / pop_est),
         ...
         incidents_k25 = (counts / total_under25))
...
gv_sf_summary %>%
  ...
  addPolygons(group = "Under 18",
              ...
              fillOpacity = 0.5,
              popup = paste0("Under 18: ", dat$total_under18, " people", "<br>",
  ...
  addPolygons(group = "Under 25",
              ...
              fillOpacity = 0.5,
              popup = paste0("Under 25: ", dat$total_under25, " people", "<br>",
                             "Total Population: ", dat$pop_est, "<br>",
...
gv_sf_summary %>%
  ...
  addPolygons(stroke = TRUE, 
              ...
              fillOpacity = 0.5,
              popup = paste0("Number of Incidents: ", gv_sf_summary$counts, "<br>",
...
gv_sf_summary %>%
  ...
  addLegend("bottomright",
            ...
            title = paste("Ratio of Incidents", "<br>", "to Youth Under 18"), 
            labFormat = labelFormat(suffix = "%"),
            opacity = 1)
```
...
## Median Earnings by Education Level {.tabset}
...
9. UVA Office of the Executive Vice President and Provost - Gun Violence Solutions Project: About - <https://provost.virginia.edu/subsite/gun-violence-solutions-project/about-gvsp> - Accessed June 1, 2024.
